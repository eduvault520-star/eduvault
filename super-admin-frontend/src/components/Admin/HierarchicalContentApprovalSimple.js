  ...
  const getMockInstitutions = () => [
    {
      ...
      location: { town: 'Njoro', county: 'Nakuru' },
      courses: generateMockCourses('1')
    },
    {
      _id: '2', 
      name: 'University of Nairobi',
      location: { town: 'Nairobi', county: 'Nairobi' },
      courses: generateMockCourses('2')
    },
    {
      _id: '3',
      name: 'Kenyatta University', 
      location: { town: 'Kahawa', county: 'Kiambu' },
      courses: generateMockCourses('3')
    }
  ];

  const generateMockCourses = (institutionId) => [
    {
      _id: `course_${institutionId}_1`,
      name: 'Bachelor of Computer Science',
      code: 'BCS',
      department: 'Computer Science',
      units: generateMockUnits(`course_${institutionId}_1`)
    },
    {
      _id: `course_${institutionId}_2`,
      name: 'Bachelor of Education',
      code: 'BED',
      department: 'Education',
      units: generateMockUnits(`course_${institutionId}_2`)
    }
  ];

  const generateMockUnits = (courseId) => [
    {
      _id: `unit_${courseId}_1`,
      name: 'Data Structures and Algorithms',
      code: 'CS201',
      year: 2,
      semester: 1,
      content: generateMockContent(`unit_${courseId}_1`)
    },
    {
      _id: `unit_${courseId}_2`,
      name: 'Database Systems',
      code: 'CS301',
      year: 3,
      semester: 1,
      content: generateMockContent(`unit_${courseId}_2`)
    }
  ];

  const generateMockContent = (unitId) => [
    {
      _id: `content_${unitId}_1`,
      title: 'Introduction to Arrays',
      type: 'video',
      filename: 'arrays_intro.mp4',
      uploadedBy: 'Dr. Jane Smith',
      uploadedAt: new Date().toISOString(),
      status: 'pending'
    },
    {
      _id: `content_${unitId}_2`,
    ...
    {
      _id: `content_${unitId}_3`,
      title: 'Mid-term Assessment',
      type: 'assessment',
      filename: 'midterm_test.pdf',
      uploadedBy: 'Dr. Mary Wilson',
      uploadedAt: new Date().toISOString(),
      status: 'pending'
    }
  ];
